...
class UpdateFacebookTrackerRequest extends FormRequest
{
    /**
    ...
    {
        // $this->facebook يأتي من اسم المتغير في ملف الراوت
        $trackerId = $this->route('facebook')->id;
    ...
    {
        $messages = (new StoreFacebookTrackerRequest())->messages();
    ...
    {
        $attributes = (new StoreFacebookTrackerRequest())->attributes();
