...
@section('title', 'إضافة بيكسل فيسبوك جديد')
...
<div class="container-fluid px-3 px-md-4">
    <div class="card card-custom">
        <div class="card-header">
            <h4 class="card-title">إضافة بيكسل فيسبوك جديد</h4>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('facebook.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-start gap-2 mt-4">
                    ...
                    <a href="{{ route('facebook.index') }}" class="btn btn-lg btn-outline-secondary">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
